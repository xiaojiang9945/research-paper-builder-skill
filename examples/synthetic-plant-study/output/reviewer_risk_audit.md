...
| 200-paper literature gate not actually run | high | literature intake | real high-ambition manuscripts require documented literature reading | label demo citation set as synthetic | run real search, screening and full-text reading matrix for real topic |
